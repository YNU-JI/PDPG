...
from val.networks import *
from torchvision.models import resnet50,vit_b_16,MaxVit,maxvit_t,vgg16,densenet121
import os
...
def get_model(MODEL_TYPE, DATA_TYPE, device, MODEL_PATH):
    if MODEL_TYPE == 'MaxVit':
        ...
        checkpoint = torch.load(MODEL_PATH + "wide-resnet-28x10.t7")
