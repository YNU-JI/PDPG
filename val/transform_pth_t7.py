...
AdvTYPE = 'clean'  # fgsm bim pgd  mim deepfool_0.3 cw
...
if AdvTYPE == 'clean':
    DATA_ROOT = f'/home/special/user/jijun/CIFAR_data'
# DATA_ROOT = '/home/special/user/jijun/ImageNet50/train_npy'
