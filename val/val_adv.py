...
import os
from utils import NpyDataset, get_model
# 下载数据集
...
DATA_Model = 'MaxVit' #  resnet50 vgg16 densenet VIT MaxVit lenet resnet18 alexnet
DATA_TYPE = 'cifar10' # cifar10 imagenet50 mnist
AdvTYPE = 'fgsm'  # fgsm bim pgd  mim deepfool_0.3 cw
MODEL_PATH = '/home/special/user/jijun/Model_Weight/'
batch_size = 250
...
DATA_ROOT = f'/home/special/user/jijun/I2I/experiments/test_purification_sr3_230927_143946/results/test/0'
# DATA_ROOT = f'/home/special/user/jijun/Adv_img/{DATA_TYPE}/test/{DATA_Model}/{AdvTYPE}'
